...
llm = ChatGoogleGenerativeAI(
    ...
    model="gemini-2.5-flash",  # You can change this to another Gemini model
    temperature=0.7,
...
Example (for Python Developer):
{
  ...
  "topics": [
    ...
    if not response_data:
        ...
        # Instead of fallback dict, raise error to avoid serialization issues
        raise Exception("Failed to generate valid roadmap from AI after multiple attempts.")
